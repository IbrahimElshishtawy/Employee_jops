...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      'onboarding.job_required': 'يرجى اختيار المسمى الوظيفي',
      'onboarding.department_required': 'يرجى اختيار القسم',
    ...
    'en': {
      ...
      'onboarding.job_required': 'Please select your job title',
      'onboarding.department_required': 'Please select your department',
