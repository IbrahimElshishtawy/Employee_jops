...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      // Chat Settings & Messaging
      'chat_settings.title': 'إعدادات المحادثات',
      'chat_settings.notifications': 'التنبيهات',
      'chat_settings.message_notifications': 'إشعارات الرسائل',
      'chat_settings.message_sound': 'صوت الرسائل',
      'chat_settings.vibration': 'الاهتزاز',
      'chat_settings.message_preview': 'معاينة الرسائل',
      'chat_settings.privacy': 'الخصوصية',
      'chat_settings.show_online_status': 'إظهار حالة الاتصال',
      'chat_settings.show_last_seen': 'إظهار آخر ظهور',
      'chat_settings.typing_indicator': 'مؤشر الكتابة',
      'chat_settings.read_receipts': 'مؤشرات قراءة الرسائل',
      'chat_settings.media_data': 'الوسائط والبيانات',
      'chat_settings.auto_download_images': 'تنزيل الصور تلقائياً',
      'chat_settings.auto_download_videos': 'تنزيل الفيديوهات تلقائياً',
      'chat_settings.wifi_only': 'التنزيل عبر Wi-Fi فقط',
      'chat_settings.media_quality': 'جودة الوسائط',
      'chat_settings.quality_low': 'منخفضة',
      'chat_settings.quality_standard': 'قياسية',
      'chat_settings.quality_high': 'عالية',
      'chat_settings.quality_original': 'أصلية',
      'chat_settings.storage': 'التخزين',
      'chat_settings.storage_usage': 'استهلاك المساحة',
      'chat_settings.images': 'الصور',
      'chat_settings.videos': 'الفيديوهات',
      'chat_settings.files': 'الملفات',
      'chat_settings.voice_messages': 'الرسائل الصوتية',
      'chat_settings.cached_data': 'البيانات المؤقتة',
      'chat_settings.total': 'الإجمالي',
      'chat_settings.clear_cache': 'مسح الذاكرة المؤقتة',
      'chat_settings.manage_storage': 'إدارة المساحة',
      'chat_settings.security': 'الحماية والأمان',
      'chat_settings.biometric_lock': 'قفل المحادثات بالبصمة',
      'chat_settings.hide_message_preview': 'إخفاء المعاينة الحساسة',
      'conversation.settings': 'إعدادات المحادثة',
      'conversation.mute': 'كتم التنبيهات',
      'conversation.search': 'البحث في المحادثة',
      'conversation.media_files': 'الوسائط والملفات والروابط',
      'conversation.pin': 'تثبيت المحادثة',
      'conversation.archive': 'أرشفة المحادثة',
      'conversation.clear_chat': 'مسح سجل الرسائل',
      'conversation.delete': 'حذف المحادثة',
      'conversation.group_settings': 'إعدادات المجموعة',
      'conversation.members': 'الأعضاء',
      'conversation.group_permissions': 'صلاحيات المجموعة',
      'conversation.leave_group': 'مغادرة المجموعة',
    ...
    'en': {
      ...
      'chat_settings.notifications': 'Notifications',
      'chat_settings.message_notifications': 'Message Notifications',
      'chat_settings.message_sound': 'Message Sound',
      'chat_settings.vibration': 'Vibration',
      'chat_settings.message_preview': 'Message Preview',
      'chat_settings.privacy': 'Privacy',
      'chat_settings.show_online_status': 'Show Online Status',
      'chat_settings.show_last_seen': 'Show Last Seen',
      'chat_settings.typing_indicator': 'Show Typing Indicator',
      'chat_settings.read_receipts': 'Read Receipts',
      'chat_settings.media_data': 'Media & Data',
      'chat_settings.auto_download_images': 'Auto Download Images',
      'chat_settings.auto_download_videos': 'Auto Download Videos',
      'chat_settings.wifi_only': 'Download Media on Wi-Fi Only',
      'chat_settings.media_quality': 'Media Quality',
      'chat_settings.quality_low': 'Low',
      'chat_settings.quality_standard': 'Standard',
      'chat_settings.quality_high': 'High',
      'chat_settings.quality_original': 'Original',
      'chat_settings.storage': 'Storage',
      'chat_settings.storage_usage': 'Storage Usage',
      'chat_settings.images': 'Images',
      'chat_settings.videos': 'Videos',
      'chat_settings.files': 'Files',
      'chat_settings.voice_messages': 'Voice Messages',
      'chat_settings.cached_data': 'Cached Data',
      'chat_settings.total': 'Total',
      'chat_settings.clear_cache': 'Clear Cache',
      'chat_settings.manage_storage': 'Manage Storage',
      'chat_settings.security': 'Security',
      'chat_settings.biometric_lock': 'Lock Chat with Biometrics',
      'chat_settings.hide_message_preview': 'Hide Message Preview',
      'conversation.settings': 'Conversation Settings',
      'conversation.mute': 'Mute Notifications',
      'conversation.search': 'Search in Conversation',
      'conversation.media_files': 'Media / Files / Links',
      'conversation.pin': 'Pin Conversation',
      'conversation.archive': 'Archive Conversation',
      'conversation.clear_chat': 'Clear Chat',
      'conversation.delete': 'Delete Conversation',
      'conversation.group_settings': 'Group Settings',
      'conversation.members': 'Members',
      'conversation.group_permissions': 'Group Permissions',
      'conversation.leave_group': 'Leave Group',
