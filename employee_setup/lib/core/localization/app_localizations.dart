...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'ar': {
      ...
      // Onboarding
      'onboarding.step1_title': 'تأكيد البيانات الشخصية',
      'onboarding.step1_subtitle': 'تأكد من صحة بياناتك الأساسية للمتابعة.',
      'onboarding.step2_title': 'بيانات العمل والوظيفة',
      'onboarding.step2_subtitle': 'حدد مسماك الوظيفي وفريق عملك.',
      'onboarding.step3_title': 'مقر العمل المعتمد',
      'onboarding.step3_subtitle': 'تأكد من موقع عملك وجهة الاتصال بـ HR.',
