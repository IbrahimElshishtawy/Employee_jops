...
import { PurchaseRequestStatus, PurchaseOrderStatus, SupplierInvoiceStatus } from "@prisma/client";
...
export class QuerySuppliersDto {
  ...
  @ApiPropertyOptional({ description: "Search by code, name, contactPerson, email" })
  @IsOptional()
  @IsString()
  search?: string;
}
