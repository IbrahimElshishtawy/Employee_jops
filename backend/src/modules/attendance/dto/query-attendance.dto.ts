...
export class QueryAttendanceDto {
  @ApiPropertyOptional({ description: 'Filter by start date (YYYY-MM-DD)', example: '2026-08-01' })
  @IsOptional()
  @IsDateString()
  startDate?: string;

  @ApiPropertyOptional({ description: 'Filter by end date (YYYY-MM-DD)', example: '2026-08-31' })
  @IsOptional()
  @IsDateString()
  endDate?: string;

  @ApiPropertyOptional({ description: 'Filter by Year-Month (YYYY-MM)', example: '2026-08' })
  @IsOptional()
  @IsString()
  month?: string;
