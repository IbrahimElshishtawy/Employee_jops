...
export class CreateGroupConversationDto {
  @ApiProperty({
    example: "Operations Team Channel",
  ...
  @ApiProperty({
    ...
    description: "List of participant user IDs to include in the group",
  })
  @IsArray()
  @ArrayMinSize(1)
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    example: "Welcome everyone to the Operations team channel!",
    description: "Optional initial welcome message",
  })
  @IsOptional()
  @IsString()
  @MaxLength(3000)
