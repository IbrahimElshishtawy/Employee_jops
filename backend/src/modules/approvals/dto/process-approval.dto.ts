...
export class ProcessApprovalDto {
  @ApiProperty({
    ...
    description: "Approval action (APPROVE, REJECT, DELEGATE, RETURN_FOR_CORRECTION)",
  })
  ...
  @ApiPropertyOptional({
    example: "Approved after reviewing team availability and project deadlines.",
  ...
  @IsNotEmpty({ message: "Rejection reason is required when rejecting a request" })
  @IsString()
