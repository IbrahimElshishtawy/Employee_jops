...
export class SyncQueueItemDto {
  @ApiPropertyOptional({
    example: "act-9876-uuid-v4",
    description: "Unique client-generated idempotency identifier",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    example: "task-uuid-or-id",
    description: "Target entity ID if mutation is an update",
  })
  @IsOptional()
  @IsString()
  entityId?: string;
...
export class PushSyncBatchDto {
  ...
  @ApiPropertyOptional({
    ...
    description: "Cursor or timestamp of last successful sync",
  })
  @IsOptional()
  @IsString()
  syncCursor?: string;
  ...
  @ApiPropertyOptional({
    example: "2026-09-03T09:00:00.000Z",
    description: "Alias for syncCursor",
  })
  @IsOptional()
  @IsString()
