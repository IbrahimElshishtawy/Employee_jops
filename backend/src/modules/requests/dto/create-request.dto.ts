...
export class CreateRequestDto {
  @ApiProperty({
    ...
    description: 'Type of the request (Leave, Absence, Permission, Late excuse, Half day, etc.)',
  })
  @IsEnum(RequestType)
  @IsNotEmpty()
  type: RequestType;
  ...
  @ApiPropertyOptional({
    example: '10:00',
    description: 'Start time in HH:mm format (required for PERMISSION, LATE_EXCUSE, EARLY_LEAVE)',
  })
  @IsOptional()
  @IsString()
  startTime?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Optional client-generated idempotency key to prevent duplicate submissions',
  })
  @IsOptional()
  @IsString()
