...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      // Employees
      'emp_title': 'Employee Management & Workforce Registry',
      ...
      'emp_basic_salary': 'Base Monthly Salary',
      ...
      'emp_directory_subtitle': 'Manage employee records, workplace assignments, attendance tracking, and operations',
      ...
      'emp_view_profile': 'View Profile',
      'emp_edit': 'Edit Profile',
      'emp_assign': 'Assign Workplace',
      'emp_status_management': 'Employment Status',
      'emp_activate': 'Activate',
      'emp_suspend': 'Suspend',
      'emp_deactivate': 'Deactivate',
      'emp_confirm_status_change': 'Confirm Status Change',
      'emp_confirm_status_msg': 'Are you sure you want to change this employee status?',
      'emp_overview': 'Overview',
      'emp_salary_comp': 'Salary & Compensation',
      'emp_activity_audit': 'Activity & Audit',
      'emp_personal_info': 'Personal Information',
      'emp_full_legal_name': 'Full Legal Name',
      'emp_primary_email': 'Primary Email',
      'emp_mobile_phone': 'Mobile Phone',
      'emp_employment_profile': 'Employment Profile',
      'emp_work_assignment': 'Work Assignment & Geofencing',
      'emp_security_mobile': 'Security & Mobile App Pairing',
      'emp_back_to_list': 'Back to Employees',
      'emp_recorded_punches': 'Recorded Punches',
    ...
    'ar': {
      ...
      'emp_overview': 'نظرة عامة',
      'emp_salary_comp': 'الراتب والمستحقات',
      'emp_activity_audit': 'سجل النشاط والتدقيق',
      'emp_personal_info': 'المعلومات الشخصية',
      'emp_full_legal_name': 'الاسم القانوني الكامل',
      'emp_primary_email': 'البريد الإلكتروني الأساسي',
      'emp_mobile_phone': 'رقم الهاتف المحمول',
      'emp_employment_profile': 'الملف الوظيفي',
      'emp_work_assignment': 'التكليف ومكان العمل',
      'emp_security_mobile': 'الأمان وربط التطبيق',
      'emp_back_to_list': 'العودة إلى الموظفين',
      'emp_recorded_punches': 'البصمات المسجلة',
